...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['task'])) {
    ...
    // Query untuk menambahkan tugas baru ke database dengan user_id
    $query = "INSERT INTO individual_tasks (user_id, text, priority, due_date_time) VALUES (:user_id, :text, :priority, :due_date_time)";
    $stmt = $pdo->prepare($query);
    $stmt->bindParam(':user_id', $user_id, PDO::PARAM_INT);
